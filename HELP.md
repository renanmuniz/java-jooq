...
* The original package name 'com.jooq.renanmuniz.java-jooq' is invalid and this project uses 'com.jooq.renanmuniz.java_jooq' instead.
...
* [JOOQ Access Layer](https://docs.spring.io/spring-boot/3.5.15/reference/data/sql.html#data.sql.jooq)
